...
import type { EvidenceID as _EvidenceID, EvidenceRecord as _EvidenceRecord, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addContact(arg0: string, arg1: string): Promise<EmergencyContactID> {
        if (this.processError) {
            try {
    ...
    async addEvidenceRecord(arg0: string, arg1: string, arg2: string | null): Promise<EvidenceID> {
        if (this.processError) {
            try {
                const result = await this.actor.addEvidenceRecord(arg0, arg1, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addLegalArticle(arg0: string, arg1: string, arg2: string): Promise<LegalArticleID> {
        if (this.processError) {
            try {
                const result = await this.actor.addLegalArticle(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async cancelSOS(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cancelSOS();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteEvidenceRecord(arg0: EvidenceID): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllLegalArticles(): Promise<Array<LegalArticle>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllLegalArticles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentSOSState(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentSOSState();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLegalArticle(arg0: LegalArticleID): Promise<LegalArticle> {
        if (this.processError) {
            try {
                const result = await this.actor.getLegalArticle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listUserContacts(): Promise<Array<EmergencyContact>> {
        if (this.processError) {
            try {
                const result = await this.actor.listUserContacts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listUserEvidenceRecords(): Promise<Array<EvidenceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.listUserEvidenceRecords();
    ...
    async removeContact(arg0: EmergencyContactID): Promise<void> {
        if (this.processError) {
            try {
    ...
    async seedDefaultLegalArticles(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedDefaultLegalArticles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async triggerSOS(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.triggerSOS();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async upsertSettings(arg0: Updates): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.upsertSettings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_EvidenceRecord_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EvidenceRecord): EvidenceRecord {
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        sosTimestamp: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.sosTimestamp)),
        displayName: value.displayName,
        user: value.user,
        isSosActive: value.isSosActive,
        pinEnabled: value.pinEnabled,
        pinHash: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.pinHash))
    };
}
...
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_EvidenceRecord>): Array<EvidenceRecord> {
    return value.map((x)=>from_candid_EvidenceRecord_n12(_uploadFile, _downloadFile, x));
}
...
function to_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        sosTimestamp: value.sosTimestamp ? candid_some(value.sosTimestamp) : candid_none(),
        displayName: value.displayName,
        user: value.user,
        isSosActive: value.isSosActive,
        pinEnabled: value.pinEnabled,
